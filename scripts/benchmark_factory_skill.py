...
DIMENSIONS = [
    {
        ...
        "checks": [
            ...
            ("SKILL.md", "Domain Affordance Discovery Rule"),
            ("references/discovery-council.md", "Direction Lock Gate"),
            ("references/discovery-council.md", "candidate_capabilities[]"),
            ("references/venue-agent-playbook.md", "Venue And Reservation Agent Playbook"),
            ("references/venue-agent-playbook.md", "Kakao Local API"),
            ("references/venue-agent-playbook.md", "booking_mode"),
            ("references/domain-affordances.md", "지도/장소 자동완성"),
    ...
    },
    {
        ...
        "checks": [
            ...
            ("templates/design-brief.md", "Design Fidelity Contract"),
            ("templates/acceptance-contract.json", "primary_scenarios"),
            ("templates/acceptance-contract.json", "capability_contract"),
            ("templates/acceptance-contract.json", "integration_contract"),
            ("templates/acceptance-contract.json", "fidelity_contract"),
            ("templates/implementation-plan.md", "Implementation"),
            ("templates/implementation-plan.md", "External Integration Plan"),
    ...
    },
    {
        ...
        "checks": [
            ...
            ("templates/factory-dashboard.html", "renderAgentSteps"),
            ("templates/factory-dashboard.html", "decision-history"),
            ("references/factory-monitor.md", "Stale Monitor Guard"),
            ("references/factory-monitor.md", "embedded_state_snapshot"),
            ("scripts/ensure_factory_monitor.py", "monitor-meta.json"),
            ("scripts/ensure_factory_monitor.py", "embed_state_snapshot"),
    ...
    },
    {
        ...
        "checks": [
            ...
            ("scripts/verify_factory_run.py", "contract-integration-missing"),
            ("scripts/verify_factory_run.py", "contract-booking-completion-proof"),
    ...
    },
    {
        ...
        "checks": [
            ...
            ("references/product-quality.md", "Design Fidelity Lock"),
            ...
            ("SKILL.md", "Design Fidelity Lock Rule"),
