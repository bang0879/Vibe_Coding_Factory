...
Use this file when running Vibe Coding Factory from Claude Code or another Claude-oriented coding workflow.
...
7. Keep monitor/report sync current before user-facing updates.
8. Before completion, run:
